...
Item {
    ...
    property double _Width: (Screen.width * horizontalScreenWidthPercent + plasmoid.configuration.widthFineTuning) - (buttonsDynamicWidth ? controlButtonsArea.width : 0)
    anchors.fill: parent
    ...
    property bool buttonsDynamicWidth: !controlButtonsArea.opacity && buttonsStandalone && plasmoid.configuration.buttonsDynamicWidth
    ...
    ListView {
        ...
        anchors.left: parent.left
        anchors.leftMargin: buttonsStandalone && (bp === 0 || bp === 2) && (!slidingIconAndText || controlButtonsArea.mouseInWidget || doNotHideControlButtons) && (canShowButtonsAccordingMaximized || !slidingIconAndText) && !buttonsDynamicWidth ? controlButtonsArea.width : 0
        anchors.right: parent.right
        anchors.rightMargin: buttonsStandalone && (bp === 1 || bp === 3) && (!slidingIconAndText || controlButtonsArea.mouseInWidget || doNotHideControlButtons) && (canShowButtonsAccordingMaximized || !slidingIconAndText) && !buttonsDynamicWidth ? controlButtonsArea.width : 0
